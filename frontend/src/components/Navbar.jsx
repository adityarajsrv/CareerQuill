const Navbar = () => {
  return (
    <div className="flex items-center justify-between p-5 text-gray-300 border-b-1">
        <div className="text-2xl font-bold text-gray-800 ml-12 cursor-pointer">Resume<span className="text-blue-500">Forge</span></div>
        ...
        <div className="flex items-center space-x-5 mr-12">
            ...
            <button className="p-2 bg-blue-500 text-white border rounded-xl cursor-pointer hover:text-black border-white">Get Started</button>
        </div>
    </div>
  )
}
